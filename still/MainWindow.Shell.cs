  ...
  core.WebMessageReceived+=async (_,e)=> {
   ...
   try {
    ...
    switch(op) {
     ...
     case "incognitoWindow":OpenIncognito();break;
     case "reorder":
     ...
     case "welcomeDone":state.Welcome=false;SaveLater();PublishAll();break;
